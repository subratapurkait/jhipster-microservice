...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'myMicroservice';
  ...
  'jhipster.mail.from' = 'myMicroservice@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'myMicroservice API';
  'jhipster.swagger.description' = 'myMicroservice API documentation';
  ...
  'eureka.instance.appname' = 'myMicroservice';
  'eureka.instance.instanceId' = 'myMicroservice:${random.value}';
  ...
  'cloud.config.name' = 'myMicroservice';
