...
export class Config {
  ...
  'jhipster.mail.from' = 'micro@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'micro API';
  'jhipster.swagger.description' = 'micro API documentation';
  ...
  'eureka.instance.appname' = 'micro';
  'eureka.instance.instanceId' = 'micro:${random.value}';
